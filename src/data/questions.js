...
export const questions = [
    ...
    },
    {
      ...
      options: ["useMemo", "useEffect", "useReducer", "useRef", "useLayoutEffect"],
      answer: "useEffect",
      points: 3
    },
    {
    ...
    },
    {
      ...
      options: ["useState", "useEffect", "useRef", "useMemo", "useCallback"],
      answer: "useRef",
      points: 4
    },
    {
      ...
      options: ["useReducer", "useMemo", "useEffect", "useCallback", "useLayoutEffect"],
      answer: "useMemo",
      points: 5
    },
    {
      ...
      options: ["useEffect", "useCallback", "useMemo", "useState", "useContext"],
      answer: "useCallback",
      points: 4
    },
    {
      ...
      options: ["Binding", "Re-renderização", "Rebuild", "Patch", "Refresh"],
    ...
    },
    {
      ...
      options: ["Redux DevTools", "React DevTools", "Chrome Inspector", "Vite Plugin", "WebPack Analyzer"],
      answer: "React DevTools",
      points: 2
    }
  ];
  
  // Função auxiliar para retornar a letra da opção
